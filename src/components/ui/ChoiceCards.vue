  ...
  <div :class="gridClasses">
    ...
    >
      <div class="relative min-h-28 overflow-hidden bg-green-600">
        ...
        <div
          v-else
          class="flex h-full w-full items-center justify-center bg-green-600 text-4xl"
        >
          ?
        </div>
      </div>
      <div
        class="relative flex flex-1 flex-col justify-between gap-3 bg-green-600 px-4 py-4"
      >
