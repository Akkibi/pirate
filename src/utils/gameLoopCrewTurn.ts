        ...
        cards: [
          {
            ...
            imageSrc: getTreasureCardDefinition('bateau-en-bouteille').imageSrc,
            imageAlt: gameText.treasureCards['bateau-en-bouteille'].title,
          },
          {
            id: 'cannon',
            title: gameText.treasureCards['poudre-a-canon'].title,
            caption: gameText.reveal.equipmentChoice.cannonCaption,
            imageSrc: getTreasureCardDefinition('poudre-a-canon').imageSrc,
            imageAlt: gameText.treasureCards['poudre-a-canon'].title,
          },
        ],
      },
    });
